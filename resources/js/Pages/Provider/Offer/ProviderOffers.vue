    ...
    <div class="col-span-6 px-[30px] py-[30px] md:px-[60px] md:py-[60px]">
      ...
      <div>
        ...
        <div>
          ...
          <div v-for="offer in offers.data" :key="offer.uuid" class="bg-white rounded-[15px] pt-[18px] mb-[18px]">
            <div class="px-[28px] mb-[35px]">
               ...
               <div class="ml-[20px] w-full">
                  <div class="flex justify-between mb-[12px]">
                    ...
                    <div>
                      <h1 class="text-[16px] font-bold">{{ offer.service_type }}</h1>
                    </div>
                  </div>
                  <div class="flex justify-between mb-[12px]">
                    <div class="flex">
              ...
              <div class="md:grid grid-cols-3 mt-[26px] ml-[78px]">
                <div class="grid grid-cols-3">
                  ...
                  <div>
                    <h1 class="text-[#24C6C9] text-[14px]">{{ offer.due_time }}</h1>
                  </div>
                  <div>
                ...
                <div class="grid grid-cols-3">
                  ...
                  <div>
                    <h1 class="text-[#24C6C9] text-[14px] font-bold">{{ offer.service_cost }}</h1>
                  </div>
                  <div>
                    <img src="/images/Line 12.png" alt="">
                  </div>
