<template>
  ...
  <div class="">
    ...
    <div
      ...
      "
    >
      <div class="grid justify-center items-center mb-[60px]">
        <div class="font-black text-[40px] text-white mb-[50px] md:mb-[0px]">
          Vehicle Service
        </div>
  ...
  <!-- About Us -->
  <div class="bg-[#24C6C9] mt-[100px] md:mt-[100px]" id="whyus">
