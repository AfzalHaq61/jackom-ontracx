  ...
  <div class="min-h-screen bg-gray-100 md:grid grid-cols-7">
    ...
    <div class="col-span-6 px-[30px] py-[30px] md:px-[60px] md:py-[60px]">
      ...
      <div>
        <!-- Services -->
        <div class="mt-[32px]">
          <div class="md:grid grid-cols-9 gap-[65px]">
            <div class="col-span-4 bg-white rounded-[20px] p-[25px] mb-[50px]">
              <div class="mb-[17px]">
              ...
              <div class="bg-white rounded-[12px]">
                <div class="flex p-[10px] mb-[14px]">
                  ...
                  <div>
                    <div class="flex justify-between">
                      <div>
                        <h1 class="text-[14px]">{{ user.name }}</h1>
                      </div>
                    </div>
                    <div>
...
function submit() {
  Inertia.post(route("user.chat.store", { user:props.user.id}), form, {
    forceFormData: true,
  });
}
</script>